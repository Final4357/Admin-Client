    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
                <NavLink to="/">
                    <img src='https://i.ibb.co/7WnPvrh/1-removebg-preview.png' alt="Logo" />
                </NavLink>
                    ...
                    <div>
                        ...
                        <ul className="mb-6 flex flex-col gap-1.5">
                                ...
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <NavLink
                                                to="/"
                                                className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-gray-100/90 dark:hover:bg-meta-4 ${(pathname === '/' ||
                            ...
                            <li>
                                <NavLink
                                    to="/calendar"
                                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-100/90 dark:hover:bg-meta-4 ${pathname.includes('calendar') &&
                                        'bg-gray-100/90 dark:bg-meta-4'
                                        }`}
                                >
                                    <svg
                            ...
                            <li>
                                <NavLink
                                    to="/profile"
                                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-100/90 dark:hover:bg-meta-4 ${pathname.includes('profile') && 'bg-gray-100/90 dark:bg-meta-4'
                                        }`}
                                >
                                    <svg
                                        className="fill-current"
                            ...
                            <SidebarLinkGroup
                                activeCondition={
                                    pathname === '/users' || pathname.includes('job')
                                }
                            >
                                {(handleClick, open) => {
                                    return (
                            ...
                            <SidebarLinkGroup
                                activeCondition={
                                    pathname === '/job' || pathname.includes('job')
                                }
                            >
                                {(handleClick, open) => {
                                    return (
                            ...
                            <li>
                                <NavLink
                                    to="/settings"
                                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-100/90 dark:hover:bg-meta-4 ${pathname.includes('settings') &&
                                        'bg-gray-100/90 dark:bg-meta-4'
                                        }`}
                                >
                                    <svg
                                ...
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <NavLink
                                                to="#"
                                                className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-100/90 dark:hover:bg-meta-4 ${(pathname === '/auth' || pathname.includes('auth')) &&
                                                    'bg-gray-100/90 dark:bg-meta-4'
                                                    }`}
                                                onClick={(e) => {
                                                    e.preventDefault();
