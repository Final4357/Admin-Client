...
import { newsDetailsById } from '../../apiRequest/newsRequest'

const NewsInfoModel = ({setShowModal}) => {
    const id = useSelector((state) => state.news.newsId)
                    ...
                    <div className="p-3 rounded-lg shadow-lg relative w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="relative p-4 job-info space-y-2 mb-2 ">
                            ...
                            <div className='w-full flex'>
                                <div className='w-[110px] flex justify-between'>
                                    <p class="text-base font-semibold dark:text-white text-gray-800">Details </p>
                                    <span className='font-bold'>:</span>
                                </div>
                                <p class="w-2/3 ms-6 text-base dark:text-gray-300 text-gray-600">{newsDetails?.smallDesc}</p>
                            </div>
                            <div className='flex'>
                                <div className='w-[110px] flex justify-between'>
                                    <p class="text-base font-semibold dark:text-white text-gray-800">News from</p>
                                    <span className='font-bold'>:</span>
                                </div>
                                <p class="ms-6 text-base dark:text-gray-300 text-gray-600">{newsDetails?.newsFrom}</p>
                            </div>
                            <div className='flex'>
                                <div className='w-[110px] flex justify-between'>
