                        ...
                        <div className="max-w-full overflow-x-auto">
                            <div className='h-[55vh] overflow-y-auto'>
                                <table className="w-full table-auto">
                                    <thead>
                                        <tr className="bg-gray-2 flex text-left dark:bg-meta-4">
                                            <th className="flex-[1] py-4 px-4 font-medium text-black dark:text-white xl:pl-11">
                                                Image
                                            </th>
                                            <th className="flex-[3] w-[100px] py-4 px-4 font-medium text-black dark:text-white xl:pl-11">
                                                Topic
                                            </th>
                                            <th className="flex-[2] py-4 px-4 font-medium text-black dark:text-white">
                                                News from
                                            </th>
                                            <th className="flex-[1] py-4 px-4 font-medium text-black dark:text-white">
                                                Actions
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {
                                            news?.map((item, i) =>
                                                <tr key={i} className='flex'>
                                                    <td className="h-fit flex-[1] border-b border-[#eee] py-5 px-2 pl-2 dark:border-strokedark xl:pl-6">
                                                        {/* <div className=""> */}
                                                            <img src={item.photo.url} className='h-12.5 w-12.5 object-fill' alt="Alumni" />
                                                        {/* </div> */}
                                                    </td>
                                                    <td className="border-b flex-[3] border-[#eee] py-5 dark:border-strokedark">
                                                        <h5 className="font-medium text-black dark:text-white">
                                                            {item.topic}
                                                        </h5>
                                                    </td>
                                                    <td className="flex-[2] border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                                        <h5 className="font-medium text-black dark:text-white">
                                                            {item.newsFrom}
                                                        </h5>
                                                    </td>
                                                    <td className="flex-[1] border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                            ...
                            <div className='flex w-full justify-center py-8 '>
                                <nav aria-label="Page navigation example" style={{ display: 'flex', justifyContent: 'center' }}>
                                    <ReactPaginate className='pagination gap-2'
                                        ...
                                        pageCount={Math.ceil(totalNews / 3)}
